...
const PublicationCard = ({ publicationItem, hidePostDetails = true, linkTo = "publication" }: Props) => {
  ...
  const content = (publicationItem as any).content || (publicationItem as any).body;
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
      ...
      <div className="md:p-5 p-2">
        ...
        <p className="mb-3 font-normal text-textColor line-clamp-2 text-sm">{unformatText(content || "")}</p>
        {!hidePostDetails && (

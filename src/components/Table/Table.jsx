  ...
  return (
    <div className="p-2 registration-table">
      ...
      <table {...getTableProps()} className="table">
              ...
              {headerGroup.headers.map((column, columnIndex) => {
                return (
                  <th
                    ...
                    }  text-center  text-white relative min-w-[60px] text-sm font-semibold border-b capitalize pt-3 pl-[6px] pr-1 pb-4  max-w-[150px] sm:max-w-[200px] break-words  gap-2`}
                  >
        ...
        <tbody {...getTableProps()}>
          {rows.map((row, index) => {
            // console.log(row, "Table Row Data");

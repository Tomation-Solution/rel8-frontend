  ...
  return (
    <div>
      ...
      <div className="bg-neutral3 px-2 py-2 rounded-md grid w-1/2">
        ...
        <select className="bg-#e6e7ea font-semibold text-#1E1E1E bg-neutral3 select-caret border-none outline-none w-full p-1 ">
          {options.map((option) => (
      ...
      <div>
        <form action="" className="flex flex-col gap-3 w-full lg:w-1/2">
          ...
          <button className="bg-primaryBlue text-white p-3 rounded-md">
            {" "}
            Add Aspirant
          </button>
        </form>

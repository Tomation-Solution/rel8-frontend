          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-justify font-light ">
                ...
                dolores vel maiores eligendi, velit modi, quam, eaque at
                voluptate autem nisi illum similique. Libero est quibusdam ex
                fugit ipsum accusamus? Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Nobis veniam distinctio sunt nostrum quod
                quibusdam corporis consequatur dolor aperiam suscipit, quam
                totam architecto similique modi laborum nam iure dicta libero.
              </p>
            </div>
          </div>
      ...
      <div className="col-span-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          <ElectionContestantCard
            image={avatarImg1}
            name="Adedeji Moyin"
            about="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit esse quis magni ipsum, molestias non fugiat, quos repudiandae ea culpa magnam repellat, iusto molestiae debitis reprehenderit veritatis expedita! Eveniet, quae."
          />
          <ElectionContestantCard
            image={avatarImg1}
            name="Adedeji Moyin"

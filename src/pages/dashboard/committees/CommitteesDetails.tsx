...
const CommitteeDetails = () => {
    ...
    return (
        <div className="bg-white shadow-md rounded-lg max-w-4xl my-8 px-5 md:px-0">
            <h2 className="text-2xl font-bold text-primary-blue mb-6">{committee?.name}</h2>
            ...
            <div className="space-y-6">
                <div>
                    <h3 className="text-xl font-semibold text-primary-dark1 mb-2">To-Do List:</h3>
                ...
                <div>
                    <h3 className="text-xl font-semibold text-primary-dark1 mb-2">Duties:</h3>
                    <ul className="list-disc ml-6 text-neutral-1">
                ...
                <div>
                    <h3 className="text-xl font-semibold text-primary-dark1 mb-2">Connected Members:</h3>
                        ...
                        {committee?.connected_members.length > 0 ? (
                            committee.connected_members.map((member: any, index: number) => (
                                <li key={index} className="p-4 bg-neutral-3 rounded-lg shadow-sm">
                                    <p className="font-medium text-primary-dark2">{member.full_name || 'Anonymous'}</p>
